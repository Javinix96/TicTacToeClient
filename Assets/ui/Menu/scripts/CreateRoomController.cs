...
public class CreateRoomController
{
    ...
    private void CreateButton()
    {
        ...
        {
            _ = PopUpController.ShowPopup("Error", "Ingrese nombre de la sala");
            return;
        }

        if (name.Length > 12)
        {
            _ = PopUpController.ShowPopup("Error", "Nombre demasiado largo");
            return;
        }
        ...
        if (!string.IsNullOrEmpty(password))
        {
            ...
            {
                _ = PopUpController.ShowPopup("Error", "Contraseña demasiada larga");
                return;
            }
        }
